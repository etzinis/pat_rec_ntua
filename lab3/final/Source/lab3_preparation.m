...
data_dir = '/home/konstantinos/Desktop/University/9th Semester/Pattern_Recognition/Lab3/PRcourse_Lab3_data/MusicFileSamples/';
...
tag_data_dir = '/home/konstantinos/Desktop/University/9th Semester/Pattern_Recognition/Lab3/PRcourse_Lab3_data/EmotionLabellingData/';
number_of_files = 412;
n_of_labelers = 3;
...
avg_activation = sum(activation,2)/3;
...
save('lab3_labels.mat', 'avg_activation', 'avg_valence');
...
for k=1:size(valence,1)
    ...
    % Tempo
    tempo_data = mirtempo(music_data);
    
    tempo= mirgetdata(tempo_data);
    
    % Harmonicity
    harmonicity_data = mirinharmonicity(music_data);
    
    harmonicity = mirgetdata(harmonicity_data);
...
features68 = [features6 ; features8];
features6 = features68;

save('features_new.mat', 'features6', 'features7');
